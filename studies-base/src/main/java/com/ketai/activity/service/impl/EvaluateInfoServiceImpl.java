...
public class EvaluateInfoServiceImpl extends ServiceImpl<EvaluateInfoMapper, EvaluateInfo> implements EvaluateInfoService {
    ...
    @Override
    public IPage<EvaluateInfo> qryEvaluateInfoPage(Page<EvaluateInfo> page, String baseName, String startTime, String endTime, String qryScore) {
        // 通过基地名称获取基地ID
        ...
        if (baseInfo != null && baseInfo.getId() != null) {
            ...
            throw new KetaiException(ResultCodeEnum.ENTITY_COULD_NOT_BE_FOUND);
        }
        return page;
    }
